...
public class AppDataDto {
    ...
    public boolean equals(Object o) {
        ...
        AppDataDto appData = (AppDataDto) o;
        ...
        if (applicationName != null ? !applicationName.equals(appData.applicationName) :
                appData.applicationName != null)
            return false;
        ...
        if (issuerOrganization != null ? !issuerOrganization.equals(appData.issuerOrganization) :
                appData.issuerOrganization != null)
            return false;
        ...
        if (subjectOrganization != null ? !subjectOrganization.equals(appData.subjectOrganization) :
                appData.subjectOrganization != null)
            return false;
        ...
        if (serviceNames != null ? !serviceNames.equals(appData.serviceNames) : appData.serviceNames != null)
            return false;
        if (contentProviderNames != null ? !contentProviderNames.equals(appData.contentProviderNames) :
                appData.contentProviderNames != null)
            return false;
        if (broadcastReceiverNames != null ? !broadcastReceiverNames.equals(appData.broadcastReceiverNames) :
                appData.broadcastReceiverNames != null)
            return false;
        if (definedPermissions != null ? !definedPermissions.equals(appData.definedPermissions) :
                appData.definedPermissions != null)
            return false;
        if (usedPermissions != null ? !usedPermissions.equals(appData.usedPermissions) :
                appData.usedPermissions != null)
            return false;
