...
<own:masterpage title="Update Sport">
    <jsp:attribute name="body">
            ...
            <div class="page-header">
                <h1>
                   <fmt:message key="sport.update"/>
                </h1>
            </div>

        <form:form method="POST"
                   action="${pageContext.request.contextPath}/sports/update/${sportUpdate.id}"
                   acceptCharset=""
                   modelAttribute="sportUpdate"
